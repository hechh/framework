...
import (
	...
	"github.com/hechh/library/base/consistent"
...
func (d *Cluster) Init(cfg *Config, self INode, types []uint32) error {
	// 初始化服务发现接口
	...
	for _, nodeType := range types {
		d.virtuals[nodeType] = consistent.NewHash[INode](DEFAULT_VIRTUAL_COUNT)
	}
