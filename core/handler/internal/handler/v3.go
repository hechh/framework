...
func NewV3Handler[Actor any, V1 any, V2 any, V3 any](en domain.IEncoder, nodeType uint32, cmd uint32, f domain.V3Func[Actor, V1, V2, V3]) *V3Handler[Actor, V1, V2, V3] {
