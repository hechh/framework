...
func NewAsyncLocker(base *domain.Attribute) *AsyncLocker {
	return &AsyncLocker{
		Attribute: base,
...
func (d *AsyncLocker) Push(t domain.ITask) (flag bool) {
...
func (d *AsyncLocker) run() {
	defer d.wg.Done() // 协程回收
