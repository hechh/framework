...
type P1Handler[Actor any, V1 any] struct {
	*Base
	define.ISerialize
	method define.P1Func[Actor, V1]
}

func NewP1Handler[Actor any, V1 any](en define.ISerialize, nodeType uint32, cmd uint32, f define.P1Func[Actor, V1]) *P1Handler[Actor, V1] {
