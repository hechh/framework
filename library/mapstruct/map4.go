...
type four[T1 comparable, T2 comparable, T3 comparable, T4 comparable] struct {
	f1 T1
	f2 T2
	f3 T3
	f4 T4
...
type Map4[T1 comparable, T2 comparable, T3 comparable, T4 comparable, V any] map[four[T1, T2, T3, T4]]V
...
func NewMap4S[T1 comparable, T2 comparable, T3 comparable, T4 comparable, V any]() *Map4S[T1, T2, T3, T4, V] {
	return &Map4S[T1, T2, T3, T4, V]{data: make(map[four[T1, T2, T3, T4]]V)}
}
